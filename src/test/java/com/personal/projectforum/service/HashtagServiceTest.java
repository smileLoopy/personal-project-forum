...
class HashtagServiceTest {
    ...
    @DisplayName("When parsing the text, hashtag names are returned without duplication")
    @MethodSource
    ...
    @DisplayName("When you enter hashtag names, those that match the names among the stored hashtags are returned without duplicates.")
    @Test
